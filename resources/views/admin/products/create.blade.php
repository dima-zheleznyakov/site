                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input name="stock" type="number" class="form-control" id="stock" placeholder="Остаток">
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input name="old-price" type="number" class="form-control" id="old-price" placeholder="Старая цена">
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input name="discount" type="number" class="form-control" id="discount" placeholder="Старая цена">
                                </div>
                            </div>
