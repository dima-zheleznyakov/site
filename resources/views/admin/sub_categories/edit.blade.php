        ...
        <div class="col-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Изменение подкатегории</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('sub.categories.update', $subCategory->id) }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" id="titleCategory" value="{{ $subCategory->title }}">
                        </div>
                        <div class="form-group">
...
{{--                        </div>--}}
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('sub.categories.index') }}" class="btn btn-primary">Назад</a>
                    </div>
                </form>
            </div>
            <!-- /.card -->
